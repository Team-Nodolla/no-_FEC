...
const RatingBreakdown = ({ metaData, handleSortClick }) => {
  ...
  return (
    <div className="breakdown-bar-container">
      <div className="rating-brakdown-bar" onClick={() => { handleSortClick(filterFiveStarReviews); }}>
      ...
      <div className="rating-brakdown-bar" onClick={() => { handleSortClick(filterFourStarReviews); }}>
      ...
      <div className="rating-brakdown-bar" onClick={() => { handleSortClick(filterThreeStarReviews); }}>
      ...
      <div className="rating-brakdown-bar" onClick={() => { handleSortClick(filterTwoStarReviews); }}>
      ...
      <div className="rating-brakdown-bar" onClick={() => { handleSortClick(filterOneStarReviews); }}>
